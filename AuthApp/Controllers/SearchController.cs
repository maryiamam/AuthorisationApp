...
namespace AuthApp.Controllers
{
    public class SearchController : Controller
    {
        ...
        [HttpPost]
        public async Task<JsonResult> FindAsync(SearchViewModel searchModel)
        {
            var results = await GetSearchResults(searchModel);
            return Json(results);
        }

        private async Task<SearchResultViewModel> GetSearchResults(SearchViewModel searchModel)
        {
